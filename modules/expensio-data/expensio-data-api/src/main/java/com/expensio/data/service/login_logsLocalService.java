...
/**
 * Provides the local service interface for login_logs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see login_logsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface login_logsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.expensio.data.service.impl.login_logsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the login_logs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link login_logsLocalServiceUtil} if injection and service tracking are not available.
	 */
