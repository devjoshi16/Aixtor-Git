...
import com.expensio.common.data.service.BudgetsService;
import com.expensio.common.data.service.BudgetsServiceUtil;
...
/**
 * Provides the base implementation for the budgets remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.expensio.common.data.service.impl.BudgetsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.expensio.common.data.service.impl.BudgetsServiceImpl
 * @generated
 */
public abstract class BudgetsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BudgetsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetsServiceUtil</code>.
	 */
	@Deactivate
	protected void deactivate() {
		BudgetsServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BudgetsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		budgetsService = (BudgetsService)aopProxy;

		BudgetsServiceUtil.setService(budgetsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BudgetsService.class.getName();
	}
	...
	@Reference
	protected com.expensio.common.data.service.BudgetsLocalService
		budgetsLocalService;
